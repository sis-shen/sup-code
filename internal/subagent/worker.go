...
func (w *Worker) executeTask(task pkg.SubTask) pkg.SubTaskResult {
    ...
    if err != nil {
        w.wtMgr.Abandon(w.pool.ctx, task.ID)
...
func (s *simpleSessionManager) AppendMessage(ctx context.Context, sessionID string, msg pkg.Message) error { return nil }
func (s *simpleSessionManager) SetState(ctx context.Context, sessionID string, state pkg.LoopState) error { return nil }
func (s *simpleSessionManager) SetPlan(ctx context.Context, sessionID string, plan pkg.Plan) error { return nil }
