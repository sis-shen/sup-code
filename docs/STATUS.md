...
| 字段 | 值 |
|---|---|
| 状态 | **PHASE_GATE（P1 本地 + CI 全绿；待合并 main 并打 tag）** |
| 当前阶段 | Phase 1 — Cordis 内核 core |
...
| P1 Cordis 内核 core | GATE（本地 + CI 全绿） | G0–G7 通过；core 覆盖率 94.0% | v2.0.0-alpha.1 | `tasks/phase-1/README.md` | `tasks/acceptance/phase-1.md` |
